...
import { H3Event, toResponse, getRequestIP, sanitizeStatusCode } from "h3-v2";
...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("./_tanstack-start-manifest_v-C_5zUva6.js");
...
const manifest = {
  "a642f4768b456b43a015bb7210e0084c413d3581b30ebfa376a3f186d5339e99": {
    functionName: "runTechnicalEvaluation_createServerFn_handler",
    importer: () => import("./ai-evaluation.functions-BN1PZZ8a.js")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-C-vKRSx3.js"),
    import("./start-BQzmZ949.js"),
